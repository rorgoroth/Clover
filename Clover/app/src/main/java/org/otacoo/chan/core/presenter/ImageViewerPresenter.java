...
import static org.otacoo.chan.utils.AndroidUtils.isConnected;
...
import org.otacoo.chan.core.saver.ImageSaveTask;
import org.otacoo.chan.core.saver.ImageSaver;
        ...
        if (viewPagerVisible) {
            ...
            if (imageAutoLoad(postImage) && !postImage.spoiler) {
                ...
                if (postImage.type == PostImage.Type.STATIC && currentMode != MultiImageView.Mode.BIGIMAGE) {
                    ...
                    // Video is already playing, onClick in MultiImageView already toggled the
                    // player controls; nothing else to do here (do NOT exit the viewer)
